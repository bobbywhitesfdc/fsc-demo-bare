...
#sf org create scratch -f config/project-scratch-def.json -a "$(prop 'default.env' )"  --set-default --duration-days 28
...
sf force data bulk upsert -o FSCDEMO -f data/acr.csv -s AccountContactRelation -i Enterprise_Party_Id__c -w 20
